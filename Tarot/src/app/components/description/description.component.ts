...
export class DescriptionComponent {
  ...
  makePayment(): void {
    ...
    this.http.post<{ id: string, links: { rel: string, href: string }[] }>('https://www.api.cartastarotbolivia.com/create-order', {})
      .subscribe((response) => {
  ...
  capturePayment(token: string): void {
    this.http.get(`https://www.api.cartastarotbolivia.com/capture-order?token=${token}`)
      .subscribe((response) => {
